...
def call(Map config = [:]) {
    ...
    withCredentials([usernamePassword(
        ...
        sh """
            # Update main application deployment - note the correct image name is taher2bedhief/echry-app
            sed -i "s|image: taher2bedhief/echry-app:.*|image: taher2bedhief/echry-app:${imageTag}|g" ${manifestsPath}/08-easyshop-deployment.yaml
